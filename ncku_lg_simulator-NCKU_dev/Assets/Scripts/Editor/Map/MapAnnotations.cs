...
public class MapAnnotations : EditorWindow
{
    ...
    private void Awake()
    {
        ...
        signalImages = new Texture[9]; // Add 4 buttons on Annotation GUI
        ...
        if (!EditorGUIUtility.isProSkin)
        {
            ...
            // Set textures for 4 buttons on Annotation GUI
            signalImages[4] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalHorizontal4.png");
            signalImages[5] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalVertical4.png");
            signalImages[6] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalHorizontal5.png");
            signalImages[7] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalVertical5.png");
            signalImages[8] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalSingle.png");
        ...
        else
        {
            ...
            // Set textures for 4 buttons on Annotation GUI
            signalImages[4] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalHorizontal4Pro.png");
            signalImages[5] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalVertical4Pro.png");
            signalImages[6] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalHorizontal5Pro.png");
            signalImages[7] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalVertical5Pro.png");
            signalImages[8] = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Editor/MapUI/MapUISignalSinglePro.png");
        ...
        signalTypeContent = new GUIContent[] {
            ...
            // Set explain texts for 4 buttons on Annotation GUI
            new GUIContent { image = signalImages[4], tooltip = "Horizontal signal with 4 lights" },
            new GUIContent { image = signalImages[5], tooltip = "Vertical signal with 4 lights" },
            new GUIContent { image = signalImages[6], tooltip = "Horizontal signal with 5 lights" },
            new GUIContent { image = signalImages[7], tooltip = "Vertical signal with 5 lights" },
            new GUIContent { image = signalImages[8], tooltip = "Single signal" },
        };
    ...
    private static void CreateSignal()
    {
        ...
        switch (signal.signalType)
        {
            ...
            case MapData.SignalType.MIX_3_VERTICAL:
                ...
                break;
            // Add SignalType for 4 and 5 Traffic Lights (Vertical & Horizontal)
            case MapData.SignalType.MIX_4_HORIZONTAL:
                signal.signalData = new List<MapData.SignalData> {
                    new MapData.SignalData() { localPosition = Vector3.right * 0.62f, signalColor = MapData.SignalColorType.Red },
                    new MapData.SignalData() { localPosition = Vector3.right * 0.20f, signalColor = MapData.SignalColorType.Yellow },
                    new MapData.SignalData() { localPosition = Vector3.right * -0.20f, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.right * -0.62f, signalColor = MapData.SignalColorType.Green },
                };
                break;
            case MapData.SignalType.MIX_4_VERTICAL:
                signal.signalData = new List<MapData.SignalData> {
                    new MapData.SignalData() { localPosition = Vector3.up * 0.62f, signalColor = MapData.SignalColorType.Red },
                    new MapData.SignalData() { localPosition = Vector3.up * 0.2f, signalColor = MapData.SignalColorType.Yellow },
                    new MapData.SignalData() { localPosition = Vector3.up * -0.2f, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.up * -0.62f, signalColor = MapData.SignalColorType.Green },
                };
                break;
            case MapData.SignalType.MIX_5_HORIZONTAL:
                signal.signalData = new List<MapData.SignalData> {
                    new MapData.SignalData() { localPosition = Vector3.right * 0.82f, signalColor = MapData.SignalColorType.Red },
                    new MapData.SignalData() { localPosition = Vector3.right * 0.41f, signalColor = MapData.SignalColorType.Yellow },
                    new MapData.SignalData() { localPosition = Vector3.zero, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.right * -0.41f, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.right * -0.82f, signalColor = MapData.SignalColorType.Green },
                };
                break;
            case MapData.SignalType.MIX_5_VERTICAL:
                signal.signalData = new List<MapData.SignalData> {
                    new MapData.SignalData() { localPosition = Vector3.up * 0.82f, signalColor = MapData.SignalColorType.Red },
                    new MapData.SignalData() { localPosition = Vector3.up * 0.41f, signalColor = MapData.SignalColorType.Yellow },
                    new MapData.SignalData() { localPosition = Vector3.zero, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.up * -0.41f, signalColor = MapData.SignalColorType.Green },
                    new MapData.SignalData() { localPosition = Vector3.up * -0.82f, signalColor = MapData.SignalColorType.Green },
                };
                break;
