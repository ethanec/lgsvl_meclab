...
{
    class RosNCKUNmeaWriter : IWriter<GpsNCKUData>
    {
        ...
        public RosNCKUNmeaWriter(Bridge bridge, string topic)
        {
            Writer = new Writer<Sentence>(bridge, topic);
        }

        public void Write(GpsNCKUData message, Action completed)
        {
            ...
            var gga = string.Format("GPGGA,{0},{1:0.000000},{2},{3:0.000000},{4},{5},{6},{7},{8:0.000000},M,{9:0.000000},M,{10:0.000000},{11:0.000000},{12:0.000000},,",
                utc,
                lat, latitudeS,
                lon, longitudeS,
                1, // GPX fix
